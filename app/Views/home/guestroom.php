		...
		<p><b>Your Reservation</b></p><hr class="line">
						...
						<div class="row">
							<div class="large-6 columns" style="max-width:100%;">
								<span class="" ><?php 
													...
													foreach (session('roomname') as &$value0 ) {
													echo $value0;
													print "<br>";
													} ;
							...
							<div class="large-4 columns" style="max-width:100%;">
								<span class="">
								<?php foreach (session('roomqty') as &$value1 ) {
													echo $value1;
													print "<br>";
													} ;
				...
				<div class="row">					
						<div class="large-12 columns" style="max-width:100%;">
							...
							<span class="fontslabo " style="font-size:32px; text-align:center;">MYR <?php echo session('deposit');?></span>
							<br><span class="fontgrey" style="text-align:center;">Total</span><br>
							<span class="fontslabo" style="font-size:32px; text-align:center;">MYR <?php echo session('total_amount');?></span></p>
		  ...
		  <div class="row">
			...
			<div class="large-6 columns">
			  <label class="fontcolor">First Name*
				<input name="firstname" type="text" value="<?php if(!empty(session('firstname'))){echo  session('firstname');}?>" pattern="[a-zA-Z\s]+" Title="Only alphabet characters allowed" placeholder="" />
			  </label>
			</div>
			<div class="large-6 columns">
			  <label class="fontcolor">Last Name*
				<input name="lastname" type="text" value="<?php if(!empty(session('lastname'))){echo  session('lastname');}?>" pattern="[a-zA-Z\s]+" Title="Only alphabet characters allowed" placeholder="" />
			  </label>
			</div>
		  </div>
		  <div class="row">
			<div class="large-6 columns">
			  <label class="fontcolor">Email Address*
				<input name="email" type="email" value="<?php if(!empty(session('email'))){echo  session('email');}?>" placeholder="" />
			  </label>
			</div>
			<div class="large-6 columns">
			  <label class="" style="color:black !important;">Telephone Number*
				<input name="phone" type="text" id="phone" value="<?php if(!empty(session('phone'))){echo  session('phone');}?>" pattern= "[^a-zA-Z]+" Title="Only numbers are allowed"  placeholder="" size="35"/>
			  </label>
			</div>
		  </div>
		  <div class="row">
			<div class="large-6 columns">
			  <label class="fontcolor">Address Line 1*
				<input name="addressline1" type="text" value="<?php if(!empty(session('addressline1'))){echo  session('addressline1');}?>"   placeholder=""/>
			  </label>
			</div>
			<div class="large-6 columns">
			  <label class="fontcolor">Address Line 2
				<input name="addressline2" type="text" value="<?php if(!empty(session('addressline2'))){echo  session('addressline2');}?>"  placeholder=""/ />
			  </label>
			</div>
		  </div>
		  <div class="row">
			<div class="large-6 columns">
			  <label class="fontcolor">Zip/Postcode*
				<input name="postcode" type="text"  value="<?php if(!empty(session('postcode'))){echo  session('postcode');}?>" pattern= "[a-zA-Z0-9\s]+" Title="Special characters such as ( ) * & ^ % $ & etc are not allowed><;"  placeholder=""/ />
			  </label>
			</div>
			<div class="large-6 columns">
			  <label class="fontcolor">City*
				<input name="city" type="text"  value="<?php if(!empty(session('city'))){echo  session('city');}?>" pattern= "[a-zA-Z0-9\s]+" Title="Special characters such as ( ) * & ^ % $ & etc are not allowed"  placeholder=""/ />
			  </label>
			</div>
		  </div>
		  <div class="row">
			<div class="large-6 columns">
			  <label class="fontcolor">State*
				<input name="state" type="text" value="<?php if(!empty(session('state'))){echo  session('state');}?>" pattern= "[a-zA-Z0-9\s]+" Title="Special characters such as ( ) * & ^ % $ & etc are not allowed"  placeholder=""/ />
			  </label>
			</div>
			<div class="large-6 columns">
			  <label class="fontcolor">Country*
				<select name="country" id="country" type="text" placeholder=""   required>
						...
						echo "<option value=\"".session('country')."\" selected=\"true\">".session('country')."</option>";
						}else
						{
		  ...
		  <div class="row">
			<div class="large-12 columns">
			  <label class="fontcolor">Special Requirements
				<textarea name="specialrequirements" placeholder=""><?php if(!empty(session('special_requirement'))){echo  session('special_requirement');}?></textarea>
			  </label>
			</div>
		  </div>
		  <div class="row">
